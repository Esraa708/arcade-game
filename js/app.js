...
const allEnemies = [new Enemy(20, 60, Math.floor(Math.random() * 70 + 100)),
    new Enemy(120, 150, Math.floor(Math.random() * 70 + 100)),
    new Enemy(220, 230, Math.floor(Math.random() * 70 + 100))
];
